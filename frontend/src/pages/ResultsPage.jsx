    ...
    <div className="relative min-h-screen overflow-hidden bg-navy-950 text-white">
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-8">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Reveal delay={160}><StatCard label="Сонгуулийн өдөр" value="1 / 2 өдөр" sub="Санал хураалт 9-р сарын 15-нд хаагдана" /></Reveal>
        ...
        <p className="mt-8 text-center text-xs text-white/30">
          ...
          хураалт 9-р сарын 15-нд 23:59 цагт хаагдсанаас хойш 24 цагийн дотор нийтэлнэ.
        </p>
      </div>
    </div>
  );
